...
export default function SoloItineraryScreen() {
        ...
        <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }}>
          {(entries?.length ?? 0) === 0 && (
            <View className="items-center py-16">
              ...
              <Text className="mt-1 text-sm text-gray-400">Add flights, hotels, and activities to keep everything in one place.</Text>
            </View>
          )}
