      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 100 }}>
        ...
        <View className="mb-4 rounded-2xl bg-white p-4 shadow-sm dark:bg-gray-800" style={{ shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 }}>
          ...
          <View className="flex-row gap-4">
            <View className="flex-1 rounded-xl bg-slate-50 p-3 dark:bg-gray-700">
              ...
              <Text className="font-semibold text-gray-800 dark:text-white">{format(new Date(trip.start_date + 'T12:00:00'), 'MMM d, yyyy')}</Text>
            </View>
            <View className="flex-1 rounded-xl bg-slate-50 p-3 dark:bg-gray-700">
              <Text className="text-xs text-gray-400">End</Text>
              <Text className="font-semibold text-gray-800 dark:text-white">{format(new Date(trip.end_date + 'T12:00:00'), 'MMM d, yyyy')}</Text>
            </View>
        ...
        <View className="mb-4 rounded-2xl bg-white p-4 shadow-sm dark:bg-gray-800" style={{ shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 }}>
          <View className="mb-3 flex-row items-center justify-between">
            ...
            <TouchableOpacity onPress={() => router.push(`/trip/${tripId}/budget`)}>
        ...
        >
          <View className="flex-row items-center gap-3">
            ...
            <View className="flex-1">
              <Text className="font-semibold text-gray-800 dark:text-white">Expenses</Text>
              <Text className="text-sm text-gray-400">Track your spending</Text>
            </View>
        ...
        <View className="mb-4 flex-row gap-3">
          ...
          >
            ...
            <Text className="text-sm text-gray-400">{pendingTaskCount > 0 ? `${pendingTaskCount} to do` : 'Checklist'}</Text>
          </TouchableOpacity>
